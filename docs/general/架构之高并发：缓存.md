...
转载于 链接：https://pdai.tech/md/arch/arch-y-cache.html
...
![img](/docs/general/imgs/arch-x-cache-1.png)
...
![img](/docs/general/imgs/arch-x-cache-2.png)
...
![img](/docs/general/imgs/arch-x-cache-4.png)
...
![img](/docs/general/imgs/arch-x-cache-5.png)
...
## [¶](#缓存实现---分布式缓存) 缓存实现 - 分布式缓存

请参考：[分布式系统 - 分布式缓存及实现方案]()

## [¶](#缓存实现方式---注解方式) 缓存实现方式 - 注解方式

### [¶](#spring注解缓存) Spring注解缓存
...
![img](/docs/general/imgs/arch-x-cache-12.png)
...
### [¶](#用户自定义注解缓存基于spring注解) 用户自定义注解缓存(基于Spring注解)
...
![img](/docs/general/imgs/arch-x-cache-13.png)
