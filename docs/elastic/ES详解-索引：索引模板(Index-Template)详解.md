...
所以在涉及内建索引模板时，要避免索引模式冲突。更多可以参考[这里  (opens new window)](https://www.elastic.co/guide/en/elasticsearch/reference/current/index-templates.html)
...
![img](/docs/elastic/imgs/es-index-template-1.png)
...
![img](/docs/elastic/imgs/es-index-template-2.png)
...
![img](/docs/elastic/imgs/es-index-template-3.png)
...
![img](/docs/elastic/imgs/es-index-template-4.png)
...
![img](/docs/elastic/imgs/es-index-template-5.png)
