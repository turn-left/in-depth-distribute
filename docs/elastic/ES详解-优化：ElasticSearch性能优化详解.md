...
### [¶](#修改-indexbuffersize-的设置) 修改 index_buffer_size 的设置
...
### [¶](#nested-object-vs-parentchild) Nested Object vs Parent/Child
...
### [¶](#选择静态映射非必需时禁止动态映射) 选择静态映射，非必需时，禁止动态映射
