...
## [¶](#constantscore固定分数查询) constant_score（固定分数查询）
...
![img](/docs/elastic/imgs/es-dsl-dismax-5.png)
...
![img](/docs/elastic/imgs/es-dsl-dismax-10.png)
