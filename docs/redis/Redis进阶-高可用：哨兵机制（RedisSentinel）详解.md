...
![img](/docs/redis/imgs/db-redis-sen-1.png)
...
![img](/docs/redis/imgs/db-redis-sen-6.jpg)
...
![img](/docs/redis/imgs/db-redis-sen-7.jpg)
...
![img](/docs/redis/imgs/db-redis-sen-2.jpg)
...
![img](/docs/redis/imgs/db-redis-sen-3.jpg)
...
![img](/docs/redis/imgs/db-redis-sen-4.png)
...
![img](/docs/redis/imgs/db-redis-sen-5.png)
