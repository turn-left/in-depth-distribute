...
![img](/docs/redis/imgs/db-redis-copy-1.png)
...
![img](/docs/redis/imgs/db-redis-copy-2.jpg)
...
![img](/docs/redis/imgs/db-redis-copy-3.jpg)
...
![img](/docs/redis/imgs/db-redis-copy-4.jpg)
