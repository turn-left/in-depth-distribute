...
![img](/docs/redis/imgs/db-redis-object-2-3.png)
...
![img](/docs/redis/imgs/redis-ds-2.png)
...
![img](/docs/redis/imgs/db-redis-ds-x-5.png)

整个ziplist在内存中的存储格式如下：

![img](/docs/redis/imgs/db-redis-ds-x-6.png)
...
![img](/docs/redis/imgs/db-redis-ds-x-7.png)
...
![img](/docs/redis/imgs/db-redis-ds-x-4.png)
...
![img](/docs/redis/imgs/db-redis-ds-x-13.png)
...
![img](/docs/redis/imgs/db-redis-ds-x-8.png)
...
![img](/docs/redis/imgs/db-redis-ds-x-9.png)

如果我们增加如下两级索引，那么它搜索次数就变成了3次

![img](/docs/redis/imgs/db-redis-ds-x-10.png)
...
![img](/docs/redis/imgs/db-redis-ds-x-11.png)
