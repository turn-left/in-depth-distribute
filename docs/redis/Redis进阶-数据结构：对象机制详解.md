...
![img](/docs/redis/imgs/db-redis-object-2-2.png)
...
![img](/docs/redis/imgs/db-redis-object-1.png)
...
![img](/docs/redis/imgs/db-redis-object-3.png)
...
![img](/docs/redis/imgs/db-redis-object-4.png)
