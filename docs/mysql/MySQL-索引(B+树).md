...
![img](/docs/mysql/imgs/061c88c1-572f-424f-b580-9cbce903a3fe.png)
...
![img](/docs/mysql/imgs/c28c6fbc-2bc1-47d9-9b2e-cf3d4034f877.jpg)

辅助索引的叶子节点的 data 域记录着主键的值，因此在使用辅助索引进行查找时，需要先查找到主键值，然后再到主索引中进行查找。

![img](/docs/mysql/imgs/7ab8ca28-2a41-4adf-9502-cc0a21e63b51.jpg)
